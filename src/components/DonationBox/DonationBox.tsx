...
const DonationBox = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      // Active l'animation dès qu'on scrolle
      setIsScrolling(true);

      // Réinitialise le timeout à chaque scroll
      clearTimeout(scrollTimeout);

      // Si pas de scroll pendant 150ms, on considère que le scroll est arrêté
  ...
  return (
    <div
      className={`donation-box ${isHovered ? "expanded" : ""} ${
        isScrolling ? "bouncing" : ""
      }`}
    ...
    >
      ...
      {isHovered && (
        <div className="info-image">
          <img
            src="https://cdn.helloasso.com/img/home/soutien-helloasso.svg"
            alt=""
            loading="lazy"
            aria-hidden="true"
          />
      ...
      <div className="info-content">
        ...
        <div className="compact-view">
          {/* <span className="soutenir-text">Soutenir</span> */}
          <span className="helloasso-text">Nous Soutenir </span>
        ...
        <div className="expanded-view">
          <p className="description">
            Un mouvement 100% financé par les citoyens
          </p>
          <a href="/modele-economique" className="learn-more">
            En savoir plus
          </a>
          <a
            href="/faire-un-don"
          ...
          >
            Je soutiens Les Petits Poussins
          </a>
        </div>
      </div>
    </div>
